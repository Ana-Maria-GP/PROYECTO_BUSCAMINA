# El patrón Singleton garantiza que solo exista una instancia de la clase Tablero en todo el programa,
# evitando así la creación de múltiples tableros en diferentes partes del código.
